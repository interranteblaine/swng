...
describe("GamePanel", () => {
  it("stroke play lists EVERY player sorted by vs-par (thru all 18, so ties never engage), not just leaders", () => {
    const participants: readonly RosterEntry[] = [
      { golferId: ANN, name: "Ann", tee: "white", strokes: 3 },
      { golferId: BO, name: "Bo", tee: "white", strokes: 0 },
      { golferId: CY, name: "Cy", tee: "white", strokes: 5 },
    ];
  ...
  it("a decided fourball match wins in the plural — the panel must match the chip", () => {
    const participants: readonly RosterEntry[] = [
      { golferId: PAT, name: "Pat", tee: "white", strokes: 3 },
      { golferId: SAM, name: "Sam", tee: "white", strokes: 1 },
      { golferId: ALEX, name: "Alex", tee: "white", strokes: 0 },
      { golferId: DANA, name: "Dana", tee: "white", strokes: 4 },
    ];
...
describe("GamePanel — header (spec §2c)", () => {
  ...
  it("stroke-play NET states the treatment as the game's own field", () => {
    const participants: readonly RosterEntry[] = [{ golferId: PAT, name: "Pat", tee: "white", strokes: 0 }];
