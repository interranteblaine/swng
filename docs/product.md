...
> **Everything counts.** Score a round once, and it simultaneously resolves every game inside it, updates every player's history and average, writes to the crew's ledger, and moves the event's standings. No round is disposable.

The POC's live multi-phone scorecard survives as the innermost kernel of the Round — but a scorecard only records what you *shot*. swng knows what you're *playing*, and what it *means*: for the match, the skins pot, the trip cup, the league table, the lifetime rivalry, your average. Meaning is the product.
...
**When the putt drops on 18.** The round archives forever as a proper scorecard. Games settle to results. Your average updates. Milestones fire (personal best, first eagle, finally beat Dave). A clean, shareable image of the final card goes to the group chat.
...
- **Milestones and seasons.** First birdie, breaking 90/80, best nine, streaks. A season arc with a trend line of your average over time, and a year-end **Season in Golf** recap built to be shared.
...
**The League.** Season container for weekly golf: divisions, generated match schedules, 9-hole matches with the same strokes model, substitutes, a points table, playoffs. The standings page everyone checks on Tuesday night — without the league runner touching a spreadsheet.
...
- **Official handicap-network integration.** Your average comes straight from your own rounds and stays that way — it is not posted to GHIN or any official handicap network. A bridge to one is a possible later add-on, not a foundation.
