...
// After a restore the record lines are whatever the projector last derived; `rebuildProjections`
// is the re-drive if they need repair.
//
...
if (restoreFile !== undefined) {
  ...
  console.log(`The record lines are whatever the projector last derived — if they need repair, rebuildProjections (the RebuildFunction lambda on swng-${stage}) re-projects every snapshot.`);
  process.exit(0);
}
